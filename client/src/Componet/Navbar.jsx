        ...
        <div className="hidden lg:flex items-center gap-3 flex-1 justify-center">
          {navLinks.map((link) => (
            <Link
              key={link.label}
              to={link.href}
              className="px-3 py-2 text-sm font-medium text-primary rounded-md hover:bg-[#EEF0FA] hover:text-secondary"
        ...
        >
          {navLinks.map((link) => (
            <Link
              ...
              className="block py-3 text-sm font-medium border-b text-primary"
              style={{
